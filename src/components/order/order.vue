<template>
  <div>
    ...
    <!-- 修改地址对话框 -->
    <el-dialog title="修改地址" :visible.sync="addrDialogVisible" @close="addrDialogClosed" width="50%">
    ...
    <!-- 物流进度对话框 -->
    <el-dialog title="物流进度" :visible.sync="progressVisible" @close="addrDialogClosed" width="40%">
      <!-- 时间线 -->
      <el-timeline>
